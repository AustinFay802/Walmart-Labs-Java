...
- `jdk17` - use Java 17 for building (backward compatibility);
- `jdk17-aarch64` - use Java 17 on aarch64 (backward compatibility).
...
To build with Java 17 (backward compatibility):

```
./mvnw clean install -Pjdk17
```
