...
- `jdk17` - use JDK 17 for backward compatibility testing;
- `jdk21-aarch64` - use JDK 21 on aarch64 for building artifacts and Docker images.

Profiles can be combined, e.g.

```
./mvnw clean install -Pdocker -Pit -Pjdk21-aarch64
```
